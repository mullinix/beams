...
% Iteration 1
% figure('Position',wind)
x1=x0-f(x0)/g(x0);%subs(f,x,x0)/subs(g,x,x0);
ea=abs((x1-x0)/x1)*100
% m=-subs(f,x,x0)/(x1-x0);
...
% Iteration 2
% figure('Position',wind)
x2=x1-f(x1)/g(x1);%subs(f,x,x1)/subs(g,x,x1);
ea=abs((x2-x1)/x2)*100
% m=-subs(f,x,x1)/(x2-x1);
...
% Iteration 3
% figure('Position',wind)
x3=x2-f(x2)/g(x2);%subs(f,x,x2)/subs(g,x,x2);
ea=abs((x3-x2)/x3)*100
x4=x3-f(x3)/g(x3);%subs(f,x,x2)/subs(g,x,x2);
ea=abs((x4-x3)/x4)*100
x5=x4-f(x4)/g(x4);%subs(f,x,x2)/subs(g,x,x2);
ea=abs((x5-x4)/x5)*100
x6=x5-f(x5)/g(x5);%subs(f,x,x2)/subs(g,x,x2);
ea=abs((x6-x5)/x6)*100
% m=-subs(f,x,x2)/(x3-x2);
